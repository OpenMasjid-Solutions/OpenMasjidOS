 ...
 * shadcn DropdownMenu.
 *
 * LOCAL EDIT (RTL): upstream ships 11 physical utilities — pl-8, pr-2, left-2,
 * ml-auto — each of which is direction-sensitive. In Arabic or Urdu they put a
 * menu item's checkmark on the wrong side and push its shortcut text the wrong
 * way. They are converted to ps-8, pe-2, start-2 and ms-auto here. Keep the
